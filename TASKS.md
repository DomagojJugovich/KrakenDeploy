...
- [ ] **6c-ui: surface captured outputs on `DeploymentDetail`** — small UI slice — add an "Output variables" tab next to "Log" and "Artifacts" that lists `DeploymentOutputVariable` rows grouped by step.
